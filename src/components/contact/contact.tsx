...
const Contact = () => {
    const ref = useRef()
    const formRef = useRef< null>(null) as React.MutableRefObject<any>
    ...
    const isInView = useInView(ref as MutableRefObject<any>, {margin: "-100px"});
  ...
  return (
    <section>
      ...
      <motion.div
        ...
        variants={variants}
        initial="initial"
        whileInView={isInView  && 'animate' as any }
      >
